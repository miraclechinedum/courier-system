            ...
            <div class="col-lg-12 col-xl-12 col-md-12">
                ...
                <div class="card pt-2">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-material" id="save_data" name="save_data" method="post" action="{{ route('store-recipient') }}">
                            @csrf
                            <section>
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="recipient_name" id="recipient_name" placeholder="Name" value="{{ old('recipient_name') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="recipient_email" id="recipient_email" placeholder="Email" value="{{ old('recipient_email') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="recipient_phone_number" id="recipient_phone_number" placeholder="Phone Number" value="{{ old('recipient_phone_number') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100% !important; z-index: 9999;" class="select2 form-control select2-hidden-accessible" name="country_modal_recipient_address" id="country_modal_recipient_address">
                                                ...
                                                <option value="{{ $country->id }}" {{ old('country_modal_recipient_address') == $country->id ? 'selected' : '' }}>{{ $country->country_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="postal_modal_recipient_address" id="postal_modal_recipient_address" placeholder="Zip Code" value="{{ old('postal_modal_recipient_address') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="address_modal_recipient_address" id="address_modal_recipient_address" placeholder="Address" value="{{ old('address_modal_recipient_address') }}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-outline-primary btn-confirmation" name="dosubmit" type="submit">Add Recipient</button>
                                </div>
                            </div>
                        </form>
