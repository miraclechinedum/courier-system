         ...
         <div class="theme-container container">
             <div class="row">
                 <div class="col-md-3 col-sm-6 footer-widget">
                     <a href="#">
                         <img class="logo" alt="#" src="build/assets/images/logo/logo-white.png" />
                     </a>
                 </div>
                 <div class="col-md-3 col-sm-6 footer-widget">
                 ...
                 <div class="col-md-3 col-sm-6 footer-widget">
                     ...
                     <ul class="payment-icons list-inline">
                         <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".20s">
                             <a href="#">
                                 <img alt="#" src="build/assets/images/icons/payment-1.png" />
                             </a>
                         </li>
                         <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".25s">
                             <a href="#">
                                 <img alt="#" src="build/assets/images/icons/payment-2.png" />
                             </a>
                         </li>
                         <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".30s">
                             <a href="#">
                                 <img alt="#" src="build/assets/images/icons/payment-3.png" />
                             </a>
                         </li>
                         <li class="wow fadeIn" data-wow-offset="50" data-wow-delay=".35s">
                             <a href="#">
                                 <img alt="#" src="build/assets/images/icons/payment-4.png" />
                             </a>
                         </li>
                     </ul>
                 </div>
